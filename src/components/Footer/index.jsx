			...
			<div className='container'>
				<div className={styles.footerInner}>
					...
					<div className={styles.contact}>
						<h4>Contact</h4>
						<p> 29 East 61st 4th Floor New York, NY 10065
							2422 Montauk Hwy, Bridgehampton, NY 11932
						</p>
						<p>Bridgehampton Salon: <b>631-537-8000</b> <br/>
					...
					<div className={styles.logoRight}>
						<img src={Rgm} alt=""/>
						<span>Web Design & Digital Marketing<br/> by  <b> Robert Gerov Media</b></span>
					</div>
				</div>
			</div>
		</div>
